package com.ishare.www.verticalscrolltext.utils;
...
import com.ishare.www.verticalscrolltext.bean.Topic;
import com.ishare.www.verticalscrolltext.bean.User;
...
public class SpanUtils{
     ...
     * @return
     */
    public static SpannableString getKeyWordSpan(int color, String str, List<String> patterStr) throws Exception {
        SpannableString spannableString = new SpannableString(str);
        for (int i = 0;i<patterStr.size();i++){
            Pattern patten = Pattern.compile(patterStr.get(i), Pattern.CASE_INSENSITIVE);
            dealPattern(color, spannableString, patten, 0);
        }
        return spannableString;
    }
